      ...
      <div className="container">
        ...
        <div className="grid md:grid-cols-3 gap-8 text-center">
          <div className="p-4 hover-scale">
            ...
            <p className="mt-2 text-muted-foreground">All our Household workers undergo thorough background checks and reference verification for your peace of mind.</p>
          </div>
          <div className="p-4 hover-scale">
            <div className="flex items-center justify-center h-12 w-12 rounded-full bg-primary text-primary-foreground mx-auto mb-4">
          ...
          <div className="p-4 hover-scale">
            ...
            <p className="mt-2 text-muted-foreground">We carefully match Household workers with families based on specific needs, preferences, and compatibility.</p>
          </div>
        </div>
      </div>
    </section>
